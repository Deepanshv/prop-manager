...
export const propertyFormSchema = z.object({
  ...
  status: z.string().optional(), // Now optional
...
export function PropertyForm({
  ...
  // This useEffect ensures the form is re-initialized with new data from props.
  // It's crucial for the "edit" scenario where data is fetched asynchronously.
  React.useEffect(() => {
    if (initialData) {
